...
/**
 * Marker映射信息对象，key--引物编号，value--Marker信息对象,
 * 一般用于高速缓存，可以快速获取相关指纹Marker信息
 * @author jiangbin
 * @date 2012-5-5上午4:21:12
 */
public class MarkerPrimerCodeMapper extends MapperTemplate<Marker, Marker> {

	private static final long serialVersionUID = 4761655855130240282L;
