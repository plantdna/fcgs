...
/**
 * 字符串对的源字符串Mapper,kye/value---target/StringPair
 * @author jiangbin
 * @date 2013-1-15下午3:28:58
 */
public class StringPairTargetMapper extends MapperTemplate<StringPair, StringPair> {

	private static final long serialVersionUID = 4282518851629731197L;

	@Override
	protected String getMapperKey(StringPair object) {
		return StringUtils.stripToEmpty(object.getTarget());
	}
